package com.polly.list.adapter

import android.view.LayoutInflater
import android.view.ViewGroup
import android.widget.TextView
import androidx.recyclerview.widget.RecyclerView
import com.polly.list.databinding.StudentListItemBinding
import com.polly.list.models.StudentDto

/**
 * Adapter 클래스
 * 복잡한 UI 를 구현하거나, 복잡한 연산을 수행할 때
 ...
 * RecyclerViewAdapter 를 만들 때는 RecyclerView.Adapter 클래스를 반드시 상속받고
 * 그리고 3개의 함수를 반드시 코딩해야 한다.
 * 이 3개의 함수를 통하여 RecyclerView 의 item 들을 화면에 표시할 수 있다.
 *
...
class StudentRecyclerAdapter(private val studentList: MutableList<StudentDto>) :
    ...
    // Inflater 를 사용하여 각 데이터 항목에 대한 View 를 생성하는 함수
     ...
     * binding 처리를 해 줄 Helper 클래스
     *
     * Layout/student_list_item.xml 파일을 binding 객체로 생성
     * (RecyclerView 내부 각각의 TextView 에 data binding 목적)
     */
